# RailsAdmin config file. Generated on March 12, 2012 12:02
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = [Cart, Order, Product, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Cart, Order, Product, User]
  ...
  #   # Found associations:
  #     configure :carts, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :name, :string 
